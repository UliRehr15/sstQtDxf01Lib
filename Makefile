...
DIST          = ../../Qt/5.5/gcc/mkspecs/features/spec_pre.prf \
		...
		sstQtDxf01Lib.pro Header/sstQtDxf01Lib.h sstQtDxf01PathStorage.cpp
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Header/sstQtDxf01Lib.h $(DISTDIR)/
	$(COPY_FILE) --parents sstQtDxf01PathStorage.cpp $(DISTDIR)/
